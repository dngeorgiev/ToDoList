    ...
    if(isset($_POST['submit'])) {
        ...
        if(!$error)
        {
            ...
            try {
                ...
                $query = 'UPDATE tasks SET `title`=:title, `content`=:content, `date`=:date, `time`=:time WHERE id=:id';
            ...
            <form action="edit.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                           ...
                           value="<?php echo $title ?: $task['title']; ?>"
                           required>
                </div>
                ...
                <div class="form-group mt-3">
                    ...
                    <textarea id="content"
                              ...
                              name="content"><?php echo $content ?: $task['content']; ?></textarea>
                </div>
